...
class Model(nn.Module):
    def __init__(self, L, P):
        ...
        self.layer1 = nn.Sequential(
            ...
            nn.Conv2d(self.L, 256, self.kernel_sizes[0], stride=self.strides[0], padding=self.padding[0]),
            nn.BatchNorm2d(256),
        ...
        self.layer2 = nn.Sequential(
            ...
            nn.Conv2d(256, 256, self.kernel_sizes[1], stride=self.strides[1], padding=self.padding[1]),
            nn.BatchNorm2d(256),
            nn.LeakyReLU(**self.lrelu_params),
        )
        ...
        self.layerskip = nn.Sequential(
            nn.ReflectionPad2d(self.padding[-1]),
            nn.Conv2d(self.L, 4, self.kernel_sizes[-1], stride=self.strides[-1], padding=self.padding[-1]),
            nn.BatchNorm2d(4),
            nn.LeakyReLU(**self.lrelu_params),
        )
        ...
        self.layer3 = nn.Sequential(
            ...
            nn.Conv2d(260, 256, self.kernel_sizes[2], stride=self.strides[2], padding=self.padding[2]),
            nn.BatchNorm2d(256),
            nn.LeakyReLU(**self.lrelu_params),
        )
        ...
        self.layer4 = nn.Sequential(
            ...
            nn.Conv2d(256, 256, self.kernel_sizes[3], stride=self.strides[3], padding=self.padding[3]),
            nn.BatchNorm2d(256),
            nn.LeakyReLU(**self.lrelu_params),
        )
        ...
        self.layer5 = nn.Sequential(
            ...
            nn.Conv2d(256, self.p, self.kernel_sizes[4], stride=self.strides[4], padding=self.padding[4]),
        )
    ...
    def forward(self, x):
        x1 = self.upsample_(self.layer2(self.layer1(x)))
